...
class ReadContacts extends StatefulWidget {
 const ReadContacts({super.key , this.chatRoomModel ,required this.userModel ,this.groupRoomModel});
             ...
             Uint8List? contactImage = contactsList[index].photo;
                ...
                return ListTile(
                  ...
                  leading: (contactsList[index].photo==null) 
                          ...
                          title: Text(contactsList[index].name.first ,style: const TextStyle(fontFamily:"EuclidCircularB")),
                  subtitle: Text(contactsList[index].phones.first.number ,style: const TextStyle(fontFamily:"EuclidCircularB")), 
                );
               },),
          ),
      
           //   to show selected contacts
          shareContactList.isEmpty 
          ? const SizedBox()
         :  Container(
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      (shareContactList[index].photo==null) 
                             ...
                             Text(shareContactList[index].name.first ,style: const TextStyle(fontFamily:"EuclidCircularB"))
                    ],),
                  ),
                   Positioned(right: 0,
                  top: -1,
